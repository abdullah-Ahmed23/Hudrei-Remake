                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    >
                        ...
                        <div className="prose prose-slate max-w-none text-brand-black/80 space-y-6">
                            ...
                            <section>
                                <h2 className="text-2xl font-bold text-brand-black mb-4">1. Acceptance of Terms</h2>
                            ...
                            <section>
                                <h2 className="text-2xl font-bold text-brand-black mb-4">2. Services Description</h2>
                            ...
                            <section>
                                <h2 className="text-2xl font-bold text-brand-black mb-4">3. Accuracy of Information</h2>
                            ...
                            <section>
                                <h2 className="text-2xl font-bold text-brand-black mb-4">4. User Responsibilities</h2>
                            ...
                            <section>
                                <h2 className="text-2xl font-bold text-brand-black mb-4">5. Limitation of Liability</h2>
                            ...
                            <section>
                                <h2 className="text-2xl font-bold text-brand-black mb-4">6. Governing Law</h2>
