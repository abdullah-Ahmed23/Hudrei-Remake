...
const TestimonialsSection = () => {
    ...
    return (
        <section
            id="testimonials"
            ref={sectionRef}
            className="pt-8 pb-20 md:pt-12 md:pb-24 bg-white overflow-hidden"
        >
            <div className="container mx-auto px-4 max-w-6xl">
                {/* Header */}
                <div className="text-center mb-14" data-aos="fade-up">
                    <span className="inline-block px-4 py-2 rounded-full bg-gray-100 text-brand-black text-sm font-medium mb-4">
                        Google Reviews
                    </span>
                ...
                <div className="relative w-full">
                    <div className="overflow-hidden p-4">
                        ...
                        >
                            {reviews.map((review, i) => (
                                ...
                                >
                                    <div className="bg-white border border-brand-black/10 rounded-[2rem] p-8 shadow-sm hover:shadow-xl transition-all duration-300 h-full flex flex-col justify-between">
                                        {/* Stars */}
                                        ...
                                        <p className="text-brand-black leading-relaxed text-center mb-8 font-medium">
                                            "{review.text}"
                                        </p>
                                        ...
                                        <div className="flex flex-col items-center justify-center mt-auto">
                                            ...
                                            <div className="font-bold text-brand-black text-center">
                                                {review.name}
                                            </div>
                                            <div className="text-xs text-brand-black/60 uppercase tracking-widest mt-1">Verified Seller</div>
                                        </div>
                                    </div>
                                </div>
                            ))}
                    ...
                    <button
                        onClick={prevSlide}
                        className="absolute left-0 top-1/2 -translate-y-1/2 -ml-2 md:-ml-8 bg-white shadow-lg border border-brand-black/10 p-3 rounded-full text-brand-black hover:text-accent hover:scale-110 transition-all z-10"
                    ...
                    <button
                        onClick={nextSlide}
                        className="absolute right-0 top-1/2 -translate-y-1/2 -mr-2 md:-mr-8 bg-white shadow-lg border border-brand-black/10 p-3 rounded-full text-brand-black hover:text-accent hover:scale-110 transition-all z-10"
